...
public class EncryptTransformFactory implements TableTransformFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder().required(EncryptTransformConfig.KEY_ENCRYPT_FIELD, EncryptTransformConfig.KEY_ENCRYPT_TYPE).build();
    }

    @Override
    public TableTransform createTransform(TableFactoryContext context) {
        CatalogTable catalogTable = context.getCatalogTable();
        return () -> new EncryptTransform(context.getOptions(), catalogTable);
    }
}
